      ...
      <div className="makeupItemCart" key={item.id}>
        <ul>
          ...
          <li><div className="ItemQuantity">
                <label className="minus-icon-cart" onClick= {() => this.props.removeItemFromCart(item)}>
                  <FontAwesomeIcon
                    icon="minus"
                  ...
                  {this.props.cart.item.filter(product => product.id === item.id).length}

                <label className="plus-icon-cart">
                  <FontAwesomeIcon
                    icon="plus"
                    className="plus-icon"
                    color="#828282"
